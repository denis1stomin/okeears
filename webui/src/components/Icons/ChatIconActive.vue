<template>
    <svg class="icon icon-chat" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 477.6 477.6">
        ...
        <path d="M308.783,225.3h-200c-7.5,0-13.5,6-13.5,13.5s6,13.5,13.5,13.5h260c7.5,0,13.5-6,13.5-13.5S376.183,225.3,368.783,225.3z"></path>
        ...
        <ellipse ry="108.42477" rx="113.78529" id="svg_9" cy="348.83206" cx="346.76538" style="fill:#ff0000;stroke:#ffffff;stroke-width:43.19473267" />
    </svg>
</template>
