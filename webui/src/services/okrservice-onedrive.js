...
export default class OneDriveOkrService {
    constructor() {

        let scopeId = localStorage.getItem(SCOPE_STORAGE_KEY);
        this.scope = scopeId ? this.getObjectiveGroups().find(each => each.id == scopeId) : this.getObjectiveGroups()[0];
    ...
    getObjectives(subjectId, userId, dataHandler, errHandler) {
        ...
        this.getSection(subjectId, readonlyMode, sectionId => {
            ...
            this.graphClient
                .api(`/users/${subjectId}/onenote/sections/${sectionId}/pages`)
...
//
        ...
        this.graphClient
                .api(`me/drive/special/approot:/dev.json:/content`)
                .header("Content-Type", "application/json")
                .put(objective)
                .then(body => {
                    console.log('#####', body);
...
//
    ...
    getPageContent(subjectId, pageId, dataHandler, errHandler) {
        this.graphClient
            .api(`/users/${subjectId}/onenote/pages/${pageId}/content`)
    ...
    searchForSection(subjectId, dataHandler, errHandler) {
        this.graphClient
            .api(`/users/${subjectId}/onenote/sections`)
