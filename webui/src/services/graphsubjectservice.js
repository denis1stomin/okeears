...
export default class GraphSubjectService {
    ...
    getUser(userResource, dataHandler, errHandler) {
        this.graphClient
            .api(userResource)
    ...
    getManagersRecursively(managersChain, userResource, dataHandler, errHandler) {
        this.graphClient
            ...
            .then((body) => {
                if (body) {
                    ...
                    this.getManagersRecursively(managersChain, nextUserResource, dataHandler, errHandler);
                }
                else {
